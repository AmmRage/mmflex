...
namespace MMF.Utility
{
    public static class CGHelper
    {
        ...
        /// <summary>
        /// Yaw (Y rotation) to Quaternion, Pitch (X rotation), function decompose to Roll (Z rotation)
        /// </summary>
        ...
        /// <summary>
        /// Describes a Quaternion's X, Y, function decompose to Z rotation
        /// </summary>
        /// <param name="input">Quaternion to decompose</param>
        ...
        /// <summary>
        /// Describes a Quaternion's Y, Z, function decomposed into X rotation
        /// </summary>
        /// <param name="input">Quaternion to decompose</param>
        /// <param name="YRot">YRotation.</param>
