...
namespace MMF.Motion
{
    ...
    internal class BoneMotion
    {
        ...
        {
            // Find the before and after of the key frame of the current frame
            ...
            // To convert Bezier function to seek a degree of progress in between the front and rear key frame of the current frame
