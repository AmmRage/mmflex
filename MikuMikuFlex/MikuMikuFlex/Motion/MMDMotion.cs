...
namespace MMF.Motion
{
    ...
    public class MMDMotion : IMotionProvider
    {
        ...
        /// <param name="ignoreParent">Whether or not to ignore the "all of the parent"</param>        
        ...
        {
            if (frame > this.FinalFrame) throw new InvalidOperationException("I was asked to play from where it exceeds the last frame.");
