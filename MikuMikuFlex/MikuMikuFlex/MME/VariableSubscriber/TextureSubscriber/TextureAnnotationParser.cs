...
{
    /// <summary>
    /// Static class containing methods useful for interpreting the annotation of the texture
    /// </summary>
    internal static class TextureAnnotationParser
    {
        /// <summary>
        /// Method to retrieve the annotation interpretation of texture commonly needed items
        /// </summary>
        ...
        /// <param name="depth">The depth of the texture (not-1)</param>
        /// <param name="mip">mipLevel</param>
        /// <param name="textureFormat">The format specified</param>
        ...
        public static Format TextureFormat(string formatString)
        {
            ...
            switch (formatString)
            {
                //Recognition of texture of DirectX9
                case "R8G8B8":
