...
namespace MMF.MME.VariableSubscriber.MaterialSubscriber
{
    internal sealed class AmbientVectorSubscriber : MaterialSubscriberBase
    {
        ...
        {
            if (this.Target == TargetObject.Geometry) SetAsVector(new Vector4(variable.Material.DiffuseColor.X, variable.Material.DiffuseColor.Y, variable.Material.DiffuseColor.Z,0), subscribeTo, this.IsVector3);
        }
