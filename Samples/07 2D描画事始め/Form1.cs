...
namespace _07_Drawing2DToRenderForm
{
    ...
    public partial class Form1 : D2DSupportedRenderForm
    {
        ...
        //So called begin and End between sprite updates must be within this method must be。
        protected override void RenderSprite()
        {
            ...
            //DrawRoundedRectangle fills the inside is FillRoundedRectangle does not fill the contents,。このように、Draw系は輪郭、Fill系は中身も塗りつぶす図形描画である。
